...
export const LABEL_COLORS: readonly LabelColor[] = [
  {
    value: "slate",
    label: "Cinza",
    badgeClassName: "bg-label-slate text-label-slate",
    swatchClassName: "bg-label-slate",
  },
  {
    value: "red",
    label: "Vermelho",
    badgeClassName: "bg-label-red text-label-red",
    swatchClassName: "bg-label-red",
  },
  {
    value: "orange",
    label: "Laranja",
    badgeClassName: "bg-label-orange text-label-orange",
    swatchClassName: "bg-label-orange",
  },
  {
    value: "amber",
    label: "Âmbar",
    badgeClassName: "bg-label-amber text-label-amber",
    swatchClassName: "bg-label-amber",
  },
  {
    value: "green",
    label: "Verde",
    badgeClassName: "bg-label-green text-label-green",
    swatchClassName: "bg-label-green",
  },
  {
    value: "teal",
    label: "Turquesa",
    badgeClassName: "bg-label-teal text-label-teal",
    swatchClassName: "bg-label-teal",
  },
  {
    value: "blue",
    label: "Azul",
    badgeClassName: "bg-label-blue text-label-blue",
    swatchClassName: "bg-label-blue",
  },
  {
    value: "violet",
    label: "Roxo",
    badgeClassName: "bg-label-violet text-label-violet",
    swatchClassName: "bg-label-violet",
  },
  {
    value: "pink",
    label: "Rosa",
    badgeClassName: "bg-label-pink text-label-pink",
